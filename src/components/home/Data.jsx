...
const Data= () => {
    return(
        <div className="home__data">
            <h1 className="home__title">Akshat Prakarsh
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className="home__description">I'm a visual designer and a React developer with a serious passion for user centric designs. When not designing, I enjoy travelling, chai and photography. </p>
